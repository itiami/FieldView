...
$groupId     = "co.wali"
$javaVersion = "21"
$bootVersion = "3.5.7"      # pick your target
# DSL Gradle with Kotlin tye will be gradle-project-kotlin
# DSL Gradle with Groovy type will be gradle-project
$type        = "gradle-project-kotlin" # for DSL Gradle with Kotlin
$packaging   = "jar"
$language    = "java"
